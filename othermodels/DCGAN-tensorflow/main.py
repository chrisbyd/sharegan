...
import numpy as np
import sys
sys.path.append("/home/chris/research_work/sharegan/othermodels/DCGAN-tensorflow")
...
flags.DEFINE_boolean("generate", False, "True for training, False for testing [False]")
