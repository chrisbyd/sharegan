...
class SGAN(object):
    ...
    def discriminator(self,x):
        ...
        self.da2 = tf.nn.max_pool(da1, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')#[-1,14,14,64]
        da3 = tf.nn.leaky_relu(tf.nn.conv2d(self.da2, W2_conv, strides=[1, 1, 1, 1], padding='SAME') + b2_conv)#
        self.da4 = tf.nn.max_pool(da3, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding='SAME')#[-1,7,7,128]
        #print(self.da4.get_shape())
        da5 = tf.reshape(self.da4, [-1, 7 * 7 * 64])
