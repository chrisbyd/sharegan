...
sample_dir='./samples/dcgan/cifar10/X_gan_dcgan_origin.npy'
real_data_dir='./datasets/cifar10/X_train.npy'

if __name__ =='__main__':
    images1=np.load(real_data_dir)
    images1=images1.transpose(0,3,1,2)
    images2=np.load(sample_dir)
    print(images2.shape)
